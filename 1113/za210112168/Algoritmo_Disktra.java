import java.util.*;
public class Algoritmo_Disktra {
    ...
    public static void main(String args[]) {
        ...
        nodos = in.nextInt();
        Algoritmo_Disktra d = new Algoritmo_Disktra();
        ...
        d.calcular(nodos, busqueda);
        System.out.println("La ruta mas corta desde el vertice de origen " +busqueda+"\t a todos los vertices son : \n");
        for(i=1;i<=nodos;i++)
            if(i!=busqueda)

                System.out.println("Busqueda :"+busqueda+"\t destino :"+i+"\t Costo Minimo es :"+d.distancia[i]+"\t");
    }
