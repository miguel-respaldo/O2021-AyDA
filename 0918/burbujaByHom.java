...
class OrdenamientoBurbuja {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Antes del método de burbuja: " + Arrays.toString(numeros));
        burbuja(numeros);
        System.out.println("Después del método de burbuja: " + Arrays.toString(numeros));
        String[] nombres = {"Leon", "Chris", "Jill", "Wesker", "Ada"};
        System.out.println("Antes del método de burbuja: " + Arrays.toString(nombres));
        burbuja(nombres);
        System.out.println("Después del método de burbuja: " + Arrays.toString(nombres));
    }
