...
public class Algoritmo_Kruscal {
    ...
    public Algoritmo_Kruscal(int n) throws IOException
    {
    ...
    public static void main(String args[]) throws IOException {
        ...
        Algoritmo_Kruscal kr=new Algoritmo_Kruscal(n);

        System.out.println("Solucion : \n");
        kr.Kruskals();
        System.out.println("El costo es de: "+ mincost);
    }
